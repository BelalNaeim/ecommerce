                                    ...
                                    <div class="owl-item deals_item">
                                        ...
                                        <div class="deals_content">
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                <div class="deals_item_category"><a href="#">{{ $hot->brand_name }}</a>
                                                </div>
                                            ...
                                            <div class="available">
                                                <div class="available_line d-flex flex-row justify-content-start">
                                                    <div class="available_title">Available:
                                                        <span>{{ $hot->Product_quantitiy }}</span>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    {{-- <div class="product_extras">
                                                        ...
                                                        <button class="product_cart_button addcart" data-id="{{ $row->id }}">Add to Cart</button>                                                    </div>
                                                </div> --}}
                                                    <div class="product_extras">
                                            ...
                                            <div
                                                ...
                                                <div class="product_content">
                                                    @if ($row->discount_price == null)
                                                        ...
                                                        <div class="product_price discount">
                                                            ${{ $row->selling_price }}<span>$300</span></div>
                                                    @else
                                                        <div class="product_price discount">
                                                            ${{ $row->selling_price }}<span>${{ $row->discount_price }}</span>
                                                        </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="{{ asset($row->image_one) }}" alt=""
                                                    style="height: 350ps;width:350px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
