...
@section('content')
    ...
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=61e01e7161edda00194ebe82&product=inline-share-buttons" async="async"></script>
                ...
                <div class="col-lg-5 order-3">
                    <div class="product_description">
                        ...
                        <div class="product_text">
                            <p>{!! str_limit($product->Product_details, 600) !!}</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Color</label><br>
                                    ...
                                    @else
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Size</label><br>
                                                <select class="custom-select custom-select-lg mb-3"
                ...
                <div class="col">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><br>
                            <a href="{{ $product->video_link }}">{{ $product->video_link }}</a>
                        </div>
