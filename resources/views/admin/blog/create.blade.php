...
@section('admin_content')
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="post_title_ar"  placeholder="Enter Post Title in Hindi">
                </div>
              </div><!-- col-4 -->
 ...
 <div class="col-lg-4">
	...
	<label class="custom-file">
		<input type="file" id="file" class="custom-file-input" name="post_image" onchange="readURL(this);" required="" style=" height:20px;
		margin-bottom:25px;
		padding-left:30px;">
