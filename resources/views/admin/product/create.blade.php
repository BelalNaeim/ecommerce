                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Quantitiy: <span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="Product_quantitiy"
                                        placeholder="Enter Product Quantitiy">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" style="position:relative;
                                    ...
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_one" onchange="readURL(this);" required="" style=" height:20px;
                                        margin-bottom:25px;
                                        padding-left:30px;">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" style="position:relative;
                                    ...
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL2(this);" required="" style=" height:20px;
                                        margin-bottom:25px;
                                        padding-left:30px;">
                                        <span class="custom-file-control"></span>
                                        <img src="#" id="two">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" style="position:relative;
                                    ...
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_three" onchange="readURL3(this);" required="" style=" height:20px;
                                        margin-bottom:25px;
                                        padding-left:30px;">
                                        <span class="custom-file-control"></span>
                                        <img src="#" id="three">
