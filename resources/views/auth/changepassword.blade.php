...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-4">
            <div class="card">
                <img src="{{ asset('public/frontend/images/belal.jpg') }}" class="card-img-top" style="height: 90px;width:90px;margin-left:34%" alt="">
                <div class="card-body">
                    <h5 class="card-title text-center">{{ Auth::user()->name }}</h5>
                </div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><a href="{{ route('password.change') }}"> Change Your Password</a></li>
